...
I forced myself to use the defaults that came with [Mantine's Vite template](https://github.com/mantinedev/vite-template), so I used Yarn as package manager.
